...
public class HomeworkTernary05 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Lütfen bir sayi degeri Giriniz");
		int sayi = scan.nextInt();
		
	String result = (sayi >= 100 && sayi<1000) ? ("3 basamakli") : (sayi %2 == 0 ? ("3 basamakli olmayan cift sayi"):("3 basamakli olmayan tek sayi"));  
