...
public class StringMethods01 {
	...
	public static void main(String[] args) {
		...
		console`da kirmizi mesajlar aliriz. Bu mesajlarda hata anlamina gelir.Bu hatalar
		kod run edildikten sonra alindigi icin "Run time error" olarak adlandirilir.
		
		*Note:charAt()metodunda var olmayan bir index kullanirsaniz run time error
		*alirsiniz.EKranda "StringIndexOutOfBoundsException" mesajini görürsünüz.
		*/
